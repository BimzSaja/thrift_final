...
<?php $__env->startSection('main'); ?>
    ...
    <div class="container-fluid text-center">
        <h3 class="" style="color: #00ffbf">Pakaian Terbaru</h3>
        <div class="d-flex flex-wrap justify-content-evenly">
            <?php $__currentLoopData = $data_pakaian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($pakaianStok > 0 && $kategoriStatus > 0): ?>
                    <div class="card m-2" style="width: 18rem;" style="background-color: #00ffbf">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo e(route('detail', ['pakaian_id' => $items->pakaian_id])); ?>"
                                class="btn" style="background-color: #00ffbf">Lihat Detail</a>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php $__env->startSection('footer'); ?>
    <div class="container-flex text-center p-4" style="background: #00ffbf">
        <div class="card text-center" style="background: #00ffbf">
            <div class="card-header" style="background: #00ffbf">
            </div>
            <div class="card-body">
            ...
            <div class="card-footer text-body-secondary" style="background: #00ffbf">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aryo Bimo\kamis 2024\Thrift_App\resources\views/web/view/dashboard.blade.php ENDPATH**/ ?>