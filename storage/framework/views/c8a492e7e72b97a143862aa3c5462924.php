...
unset($__errorArgs, $__bag); ?>
                    <div class="form-group my-3 d-grid">
                        <button class="btn" style="background-color: #06c3ee;color:white" type="submit">Login</button>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aryo Bimo\kamis 2024\Thrift_App\resources\views/public/login.blade.php ENDPATH**/ ?>