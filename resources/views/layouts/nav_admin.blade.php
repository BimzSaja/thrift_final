<nav class="navbar shadow-xl" style="background-color: #00ffbf;">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" style="color: white;"
            ...
            <div class="offcanvas-header" style="background-color: #00ffbf; color: white; padding: 8px">
            ...
            <div class="offcanvas-footer" style="background-color: #00ffbf; color: white;">
