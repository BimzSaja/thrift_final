...
@section('main')
    ...
    <div class="container mt-5 text-center">
        ...
        @if ($cart)
            ...
            <div class="table-responsive">
                <form id="insert_pembelian" action="{{ route('action.create_data_pembelian') }}" method="post">
                    ...
                    <div class="d-grid m-4">
                        <button type="submit" form="insert_pembelian" class="btn" style="background: #00ffbf">Simpan</button>
                    </div>
                @else
            ...
            <div class="d-grid m-4">
                <button type="submit" form="insert_pembelian" class="btn disabled" style="background: #00ffbf">Simpan</button>
            </div>
        @endif
        </form>
        <script>
    ...
    @else
        <h3 class=" m-3" style="color: #00ffbf">Anda tidak memiliki Pakaian untuk dibeli</h3>
        <hr />
        <h3 class="m-3" style="color: #00ffbf">Riwayat Pembelian</h3>
        <div class="table-responsive">
            <table class="table align-middle table-bordered table-hover">
                <thead class="align-middle text-center">
                    <tr>
                        ...
                        <div class="modal fade" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #00ffbf">
                                            ...
                                            @foreach ($details as $detail)
                                                ...
                                                <li
                                                    ...
                                                    <span class="badge rounded-pill"
                                                        style="background-color: #00ffbf">Jumlah :
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn" style="background: #00ffbf">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
