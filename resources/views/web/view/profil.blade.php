                ...
                <div class="modal fade" data-bs-backdrop="static" id="{{ $modalId }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #00ffbf">
                            ...
                            <form action="{{ $formAction }}" method="post">
                                ...
                                <div class="modal-footer">
                                    <button type="submit"
                                        class="btn btn-{{ $hasPaymentMethod ? 'warning' : 'primary' }}" style="background: #00ffbf">{{ $hasPaymentMethod ? 'Ubah' : 'Simpan' }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
