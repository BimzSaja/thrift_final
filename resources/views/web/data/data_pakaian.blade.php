    ...
    <section class="pt-2 container pb-5">
        ...
        <div class="container-fluid px-4 pt-4 pb-5">
            <div class="row gap-4 justify-content-sm-around">
                ...
                @endif
                <center>
                    <button type="button" class="btn" style="background-color: #00ffbf" data-bs-toggle="modal"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn" style="background-color: #00ffbf">Simpan</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
