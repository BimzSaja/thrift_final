...
@section('main')
    <section class="pt-2 container pb-5">
        <div class="card text-center border-2">
            <div class="card-body" style="background-color: #00ffbf">
        ...
        <div class="container-fluid px-4 pt-4 pb-5">
            <div class="row gap-4 justify-content-sm-around">
                ...
                @endif
                <center>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#insertUserModal" style="background-color: #00ffbf">
                        Tambah User
                    </button>
                </center>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('data_user.update', ['user_id' => $items->user_id]) }}"
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn" style="color: #00ffbf">Simpan</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
...
@section('footer')
    <div class="fixed-bottom p-3" style="background-color: #00ffbf" >
