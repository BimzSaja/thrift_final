...
@section('header')
    <style>
        body {
            background: radial-gradient(circle at top right, transparent 10%, #00ffbf 10%, #00ffbf 20%, transparent 21%), radial-gradient(circle at left bottom, transparent 10%, #00ffbf 10%, #00ffbf 20%, transparent 21%), radial-gradient(circle at top left, transparent 10%, #00ffbf 10%, #00ffbf 20%, transparent 21%), radial-gradient(circle at right bottom, transparent 10%, #00ffbf 10%, #00ffbf 20%, transparent 21%), radial-gradient(circle at center, #00ffbf 30%, transparent 31%);
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body container-fluid px-4 pt-4">
                <form class="row g-3 needs-validation" action="{{ route('user.register') }}" method="post">
                    ...
                    <div class="d-grid">
                        <button class="btn btn-primary" type="submit" style="background-color: #00ffbf; color: white">Register</button>
                    </div>
                </form>
            </div>
            <div class="card-footer">
                <a href="{{ route('login') }}" class="link-underline link-underline-opacity-0">
                    <p class="text-center" style="color: #00ffbf;">
